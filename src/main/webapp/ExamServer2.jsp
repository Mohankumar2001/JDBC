...
<body>
<h2 style="text-align:center">Round II results</h2>
<p>
<a href="examclient.html">Back To Computer Networks Quiz</a>
</p>
<hr/>
<%
int N = 5;
...
if(mark>=N/2)
{
 ...
 out.println("<h3>Congratulations....! You Passed Round II</h3>");
}
else
{
 out.println("<h4>Your Mark is : "+mark+"</h4>");
